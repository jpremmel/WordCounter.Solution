...
| The program accepts a single word and a sentence from the user and determines whether the word is present at all in the sentence | "cat; I own a cat and you own a cat." | "Number of times 'cat' was found: 1" |
